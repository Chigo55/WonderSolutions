---
name: wonder-cave-man
description: Ultra-compressed communication mode. Cuts token usage ~75% by dropping filler, articles, and pleasantries while keeping full technical accuracy. Use when user says "caveman mode", "talk like caveman", "use caveman", "less tokens", "be brief", or invokes /cave-man.
---

> Generated from `plugins/wonder-utilities/skills/cave-man/SKILL.md` by `npm run sync:codex` — do not edit by hand.
