---
name: modifier
description: Stage 6 of the wonder-workflows pipeline. Analyzes inspection-report.md, prioritizes fixes, guides developer to apply them, then writes modification-report.md. Invoked by orchestrator only.
tools: Read, Write, Agent
---

# modifier

Performs Stage 6 (Modification) of the wonder-workflows pipeline.
