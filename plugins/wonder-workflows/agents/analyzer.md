---
name: analyzer
description: Stage 1 of the wonder-workflows pipeline. Analyzes the task context — current codebase state, affected scope, and clarified requirements. Writes §Analysis to the run's work-doc.md. Invoked by orchestrator only.
tools: Read, Grep, Glob, Write
---

# analyzer

Performs Stage 1 (Analysis) of the wonder-workflows pipeline.
